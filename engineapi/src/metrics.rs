...
pub const _GET_BLINDED_PAYLOAD: &str = "get_blinded_payload";
pub const _GET_BLINDED_PAYLOAD_LOCAL: &str = "get_blinded_payload_local";
pub const _GET_BLINDED_PAYLOAD_BUILDER: &str = "get_blinded_payload_builder";
pub const _POST_BLINDED_PAYLOAD_BUILDER: &str = "post_blinded_payload_builder";
